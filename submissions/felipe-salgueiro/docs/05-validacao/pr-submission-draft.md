...
Para rodar localmente, clone o fork e siga o [setup da aplicação](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/solution/app/README.md). Para conferir a origem dos números, consulte o [banco de evidência](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/solution/data/evidence/README.md). O snapshot é sintético e estático: não é um painel conectado aos canais ou CRM do G4.

[Relatório executivo para o Head de Marketing](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/solution/reports/README.md): oito respostas organizadas em três pilares, provas numéricas e estratégia. Acesse pela aplicação ou baixe/clone e abra `solution/reports/performance-strategy.html` no navegador.

As versões iniciais foram reprovadas por mim e reformuladas para leitura gerencial. As correções e os limites dos testes estão nos [checkpoints](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/05-validacao/).

[Aplicação e setup](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/solution/app/README.md), [contrato de dados](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/solution/data/app/README.md) e [simulador](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/05-validacao/checkpoint-mar103-simulator.md): cálculo determinístico de custo por mil views, interação e venda; cenário hipotético, não resultado comercial observado.

[Explorador dos dados Ouro](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/solution/prototype/README.md): disponível na aplicação e como HTML local em `solution/prototype/index.html`. O GitHub exibe o código-fonte; a Preview permite navegar.
...
3. **Separei as perguntas em análise, estratégia e ferramenta de decisão.** Pedi uma frente independente de auditoria enquanto discutia os requisitos com o time de agentes. O planejamento passou por [Brief](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/01-brief/brief.md), [PRD](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/02-prd/prd.md), arquitetura e [tarefas](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/04-planejamento/issues/README.md). Os documentos preservam propostas históricas; nem toda capacidade discutida virou implementação.
4. **Exigi uma origem verificável para cada número.** Preservei a fonte na Bronze, validei e derivei métricas na Prata e produzi comparações na Ouro. Mantive o SQLite reconstruível no fork para auditoria e usei exportações estáticas na aplicação, evitando banco e infraestrutura adicionais no deploy. O [contrato de dados](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/solution/data/app/README.md) explica o consumo.
...
7. **Validei antes de preparar a submissão.** Usei gates de lint, tipos, testes e build, além de QA no Brave e correções após minha leitura. Autorizei revisão pelo próprio modelo para equilibrar prazo e qualidade, sem declarar revisão independente inexistente. A [matriz de validação](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/05-validacao/submission-audit.md) distingue cobertura comprovada de limites.

O [diário do processo](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/workflow.md) preserva a sequência, mudanças de ideia e intervenções; os [exports multiagente](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/chat-exports/README.md) mostram mensagens visíveis de 15 sessões. Esta seção é a síntese das decisões registradas, não uma reconstrução de raciocínio interno dos modelos.

### Resultados / Findings
Pipeline analítico, banco de evidência, exportador e comparações descritivas integrados. A análise utiliza 52.214 posts; os resultados e suas provas estão no relatório executivo. [Reprodução e artefatos](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/solution/README.md).
...
O [relatório executivo](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/solution/reports/README.md) detalha as oito perguntas, números e condições. O plano semanal é proposto, não uma série temporal real do G4.
...
- **Validação:** os gates e o QA cobrem os casos registrados, não todos os dispositivos ou uma auditoria completa de acessibilidade. O [checkpoint do Brave](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/05-validacao/checkpoint-qa-brave.md) explicita o que foi testado.
...
Segui meu **Dev Workflow do PD Framework**: briefing → PRD → RFC/arquitetura → decomposição em tarefas → implementação → validação → Preview → revisão humana → preparação da PR. Usei Linear para organizar o trabalho, Obsidian para registrar decisões e Git para checkpoints. A [documentação por etapa](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/README.md) e as [tarefas exportadas](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/04-planejamento/issues/README.md) permitem conferir esse processo sem acesso às minhas ferramentas privadas.
...
Não atribuo um único modelo a toda a execução nem confundo uma persona com um modelo independente. O [método](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/metodo/README.md), os [checkpoints de validação](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/05-validacao/submission-audit.md) e os [exports](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/chat-exports/README.md) documentam o uso e seus limites.
...
O [registro detalhado](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/workflow.md) documenta as iterações por frente. Não há contagem auditada de todos os prompts; os ciclos documentados não são apresentados como total exato.
...
Evidências: [workflow](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/workflow.md) — especialmente itens 41, 67–70, 83, 89 e 126–138 —, [screenshots contextualizados](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/evidencias/README.md), [QA no Brave](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/05-validacao/checkpoint-qa-brave.md) e [histórico Git](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/git-history.md).
...
## Evidências
- [Histórico Git da branch de submissão](https://github.com/felipeluissalgueiro/ai-master-challenge/commits/submission/felipe-salgueiro/) e [guia dos checkpoints](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/git-history.md) — evolução real do código, correções e decisões de escopo.
- [Revisão contra o guia e cobertura das oito perguntas](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/05-validacao/submission-audit.md).
- [Planejamento e issues exportadas](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/04-planejamento/issues/README.md) — leitura no próprio repositório, sem depender do Linear ou da renderização do GitHub Projects.
- [Projeto e marcos](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/00-projeto/README.md).
- [Documentos por etapa](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/README.md).
- [Pesquisa preparatória e ressalvas](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/01-brief/pesquisa/README.md).
- [Workflow](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/README.md), [48 screenshots do processo](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/evidencias/README.md) e [proveniência dos exports](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/docs/proveniencia.md).
- [Conversas de 15 sessões do projeto](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/chat-exports/README.md), com [legenda das personas](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/README.md#quem-são-as-personas-mencionadas).

O [snapshot integral do banco](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/solution/data/evidence/README.md) está no fork com manifesto e limites conhecidos; a aplicação usa exportações Ouro, sem SQLite no deploy. O histórico Git registra a evolução, sem retroagir datas. Incluí uma [seleção de vídeo do processo](https://github.com/felipeluissalgueiro/ai-master-challenge/blob/submission/felipe-salgueiro/submissions/felipe-salgueiro/process-log/videos/README.md), de 24 segundos, com cortes documentados; gravações brutas e notebook não foram anexados. Chat com LLM e integração ao CRM não fazem parte da versão entregue.

**Data de preparação:** 23/09/2026; envio registrado pelo GitHub.
